    ...
    <div className="px-8 py-10">
      <div className="flex w-full flex-col lg:flex-row justify-between flex-wrap items-center mx-auto">
        ...
        >
          ...
          <span className="text-[#fb8618]">.</span>
        </p>
        <p
          className="text-[#fb8618] text-center text-sm md:text-base lg:max-w-sm mb-8"
          data-aos="fade-left"
        >
          Wide range of apps, utilities and solutions powering the protocol
          creating a True One-Stop Ecosystem for all your DeFi needs.
        </p>
      </div>
      <div className="">
              ...
              <div className="">
                <div>
                  ...
                  <p className="text-sm text-[#fff9] mb-10 line-clamp-[7]">
                    Our Liquidity Pool rewards system provides a win-win
                    situation for users by allowing them to add liquidity and
                    earn rewards. By contributing liquidity to a Liquidity Pool,
                    users receive Liquidity Provider (LP) tokens and a share in
                    the fees generated by traders. This incentivizes users to
                    hold their assets in our platform while also supporting the
                    project. Users can easily remove their liquidity at any
                    time.{" "}
                    <span className="cursor-pointer text-[#fb8618]">
                      <span className="expand">Read more</span>
                    </span>
            ...
            <div className=" border border-[#393939] rounded-xl px-4 py-5">
              <div className="main_container">
                <div>
                  ...
                  <p className="text-sm text-[#fff9] mb-10">
                    Our XOX Gamified Referral Program is the first of its kind
                    ...
                    level system based on points. Users can earn points, level
